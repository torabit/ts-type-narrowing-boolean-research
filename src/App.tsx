...
export function App() {
  return (
    <div style={{ fontFamily: "monospace", padding: 24 }}>
      ...
      <Problem response={sampleResponse} />

      <h2>Pattern 1: inline check (直接条件で narrowing)</h2>
      <Pattern1_InlineCheck response={sampleResponse} />

      <h2>Pattern 2: type predicate (ユーザー定義型ガード)</h2>
      <Pattern2_TypePredicate response={sampleResponse} />

      <h2>Pattern 3: early return</h2>
      <Pattern3_EarlyReturn response={sampleResponse} />

      <h2>Pattern 4: non-null assertion (!)</h2>
      <Pattern4_NonNullAssertion response={sampleResponse} />
